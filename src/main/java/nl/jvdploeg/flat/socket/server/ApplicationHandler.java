...
public class ApplicationHandler extends SimpleChannelInboundHandler<WebSocketFrame> {
    ...
    private static final AttributeKey<ChangeConsumer> CHANGE_CONSUMER = AttributeKey.newInstance("changeConsumer");
    private static final AttributeKey<CommandHandler> COMMAND_HANDLER = AttributeKey.newInstance("commandHandler");
    private static final AttributeKey<ResponseConsumer> RESPONSE_CONSUMER = AttributeKey.newInstance("responseConsumer");
     ...
     * {@inheritDoc}
     *
     * To know once a handshake was done you can intercept the {@link ChannelInboundHandler#userEventTriggered(ChannelHandlerContext, Object)} and
     * check if the event was instance of {@link HandshakeComplete}, the event will contain extra information about the handshake such as the request
    ...
    public void userEventTriggered(final ChannelHandlerContext ctx, final Object evt) throws Exception {
        ...
        if (evt instanceof HandshakeComplete) {
            ...
            LOG.info("handshake requestUri:" + handshake.requestUri() + ", selectedSubprotocol:" + handshake.selectedSubprotocol()
                    + ", requestHeaders:" + handshake.requestHeaders().entries());
