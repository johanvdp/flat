...
public class WebSocketHandler extends SimpleChannelInboundHandler<Object> implements Publisher<String> {
    ...
    public void channelRead0(final ChannelHandlerContext ctx, final Object msg) throws Exception {
        ...
        if (msg instanceof TextWebSocketFrame) {
            ...
            final Throwable t = new IllegalStateException(
                    "unexpected response: [" + response.status() + ", " + response.content().toString(CharsetUtil.UTF_8) + ']');
            ch.close();
