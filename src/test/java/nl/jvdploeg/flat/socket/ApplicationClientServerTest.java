...
public class ApplicationClientServerTest {
  ...
  public void testChanges() throws Exception {
    ...
    while (copy.getRoot().findChild("A") == null
        || copy.getRoot().findChild("A").findChild("B") == null) {
      Thread.yield();
    }
  ...
  public void testCommand() throws Exception {
    ...
    final CollectingConsumer<Command> input = (CollectingConsumer<Command>) serverApplication
        .getInput();
  ...
  public void testResponse() throws Exception {
    ...
    Assert.assertEquals(response, clientResponse);
  }
