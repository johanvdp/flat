...
public class ModelTest {
    ...
    public void testGetBestValue() {
        Assert.assertEquals(null, NodeValueUtils.getBestValue(model.getRoot(), PATH_EMPTY.createChildPath("B")));
        Assert.assertEquals("b", NodeValueUtils.getBestValue(model.getRoot(), PATH_A.createChildPath("B")));
        Assert.assertEquals("b", NodeValueUtils.getBestValue(model.getRoot(), PATH_A_A.createChildPath("B")));
        Assert.assertEquals("b", NodeValueUtils.getBestValue(model.getRoot(), PATH_A_B.createChildPath("B")));
        Assert.assertEquals("bb", NodeValueUtils.getBestValue(model.getRoot(), PATH_A_C_E.createChildPath("B")));
        Assert.assertEquals("bb", NodeValueUtils.getBestValue(model.getRoot(), PATH_A_C_E_B.createChildPath("B")));
    }
